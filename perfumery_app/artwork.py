...
def build_fragrance_artwork(fragrance: dict) -> bytes:
  ...
  <text x="80" y="126" fill="#F9EBDD" font-family="'Cormorant Garamond', Georgia, serif" font-size="58" font-weight="600">{name}</text>
  ...
  <text x="360" y="428" fill="rgba(255,255,255,0.92)" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, serif" font-size="42" font-weight="600">{brand}</text>
  ...
  <text x="80" y="744" fill="#FFF6EC" font-family="'Cormorant Garamond', Georgia, serif" font-size="38">{top}</text>
  ...
  <text x="80" y="840" fill="#FFF6EC" font-family="'Cormorant Garamond', Georgia, serif" font-size="34">{base}</text>
  ...
  <text x="462" y="744" fill="#FFF6EC" font-family="'Cormorant Garamond', Georgia, serif" font-size="28">{sale_text}</text>
  ...
  <text x="462" y="840" fill="#FFF6EC" font-family="'Cormorant Garamond', Georgia, serif" font-size="34">{price_text}</text>
